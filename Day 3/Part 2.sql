...
......696..................................................753......................957.715.............396..159...........338.......806....]', chr(10) )
...
)-- cycle rn, start_pos, pattern_str set cycle to 1 default 0
, all_numbers as (
  select n.*
  from find_pattern n
...
--    and cycle = 0
  ...
  where domain_check( is_a_symbol, pattern_str ) is true
--    and cycle = 0
), final_table as (
...
select sum( to_number( first_num ) * to_number( last_num ) ) answer from (
  select rn, start_pos, pattern_str, count(*) N
    ,min(num_str) keep (dense_rank first order by num_rn, num_start_pos) first_num
    ,min(num_str) keep (dense_rank last order by num_rn, num_start_pos) last_num
  from final_table
  where pattern_str = '*'
  group by rn, start_pos, pattern_str
  having N = 2 -- huh ?? not a triple
  order by rn, start_pos, pattern_str
)
;
-- 76504829