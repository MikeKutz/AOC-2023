with
  ...
  inputdata (txt) as (
    select q'[
...
NQN = (SJT, BFL)
  ...
  select f.direction_list
    ...
    ,mod(current_step, length(a.my_gps)) +1 use_me
  from follow_tomtom f
        join locations g on f.current_location = g.area_location
    ,all_directions a
  where current_location != 'ZZZ' and current_location is not null
    -- and current_step < 5
...
from (
  select *
  from locations
  where substr(area_location,-1) in ('Z')
)
/
